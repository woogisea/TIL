...
var btnDecrease = document.querySelector('#decrease'); //상태에 변화를 일으키는 액션 정의

var TOGGLE_SWITCH = "'TOGGLE_SWITCH";
var INCREASE = "INCREASE";
var DECREASE = "DECREASE"; //액션 생성 함수, type 값은 반드시 가지고 있어야 한다.
//type 값은 액션의 이름
...
render(); //dispatch 되어 상태가 업데이트 되면 호출

store.subscribe(render); //dispatch 호출되면 새로운 상태를 만들어 준다.
